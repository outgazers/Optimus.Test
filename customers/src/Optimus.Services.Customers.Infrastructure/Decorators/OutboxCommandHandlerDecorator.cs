...
namespace Optimus.Services.Customers.Infrastructure.Decorators;
    ...
    where TCommand : class, ICommand
{
    ...
    public Task HandleAsync(TCommand command, CancellationToken cancellationToken = new CancellationToken())
        => _enabled
