...
public class EventMapper : IEventMapper
{
    ...
    public IEvent Map(IDomainEvent @event)
    {
        switch (@event)
        {
            case CustomerRegistrationCompleted e: return new Optimus.Services.Customers.Application.Events.CustomerCreated(e.Customer.Id, e.Customer.ModsOfTransportation, e.Customer.Industry, e.Customer.Address);
